...
from .db.models import User, Survey, Option, Vote, VoteOption
...
def init_app(app):
    ...
    def create_survey():
        if request.method == 'POST':
            ...
            survey = Survey(title=title, description=description, created_by=created_by, is_single_choice=bool(is_single_choice))
    ...
    def add_option(survey_id):
        work_with_option = request.form.get('work_with_option')
        print(work_with_option)
        if request.method == 'POST' and work_with_option == 'add_option':
